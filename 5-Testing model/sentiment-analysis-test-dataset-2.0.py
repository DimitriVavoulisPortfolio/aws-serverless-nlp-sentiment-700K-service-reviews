...
def preprocess_data(examples, tokenizer):
    ...
    encodings = tokenizer(examples['review_text'], truncation=True, padding='max_length', max_length=128)
    encodings['labels'] = examples['sentiment']  # Sentiment is already 0 or 1
    return encodings
...
def main():
    ...
    if not all(col in df.columns for col in required_columns):
        print(f"Error: Required columns not found. Need {required_columns}.")
        return
